    ...
    <div className="p-8">
      <div className="max-w-md w-full mx-auto rounded-md md:rounded-2xl p-4 md:p-8 shadow-input bg-white dark:bg-black">
        <h2 className="font-bold text-xl text-neutral-800 dark:text-neutral-200">
          Chào mừng đến T&Đ Score Management
        </h2>
        <p className="text-neutral-600 text-sm max-w-sm mt-1 mb-4 dark:text-neutral-300">
          Hãy đăng nhập hoặc đăng ký để quản lý điểm sinh viên
        </p>
